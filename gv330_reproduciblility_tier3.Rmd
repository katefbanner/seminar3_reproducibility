---
title: 'GV330: Seminar 3, Reproducibility -- Tier 3'
author: ""
date: "`r Sys.Date()`"
...
## Tier 3: Modular Programming and Getting DRY
...
# now let's run just one line of code:
our_program()
...
What we have here is now pretty powerful. In a few lines of top-level code we could vary the cleaning of our data, produce lots of varied analyses and plots, save them in a strong and hygenic folder structure. If we want to make changes to our program we know precisely where to look in the codebase. We would implement those changes, re-source, and then re-run our program. Life is pretty good.
